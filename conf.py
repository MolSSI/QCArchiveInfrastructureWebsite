...
You can run this notebook online in a `Binder <https://mybinder.org/v2/gh/MolSSI/QCArchiveInfrastructureWebsite/master?urlpath=lab/tree/{{ docname }}>`_
session or view it `on Github <https://github.com/MolSSI/QCArchiveInfrastructureWebsite/blob/master/{{ docname }}>`_.
...
htmlhelp_basename = 'QCArchivedoc'
...
latex_documents = [
    (master_doc, 'QCArchive.tex', 'QCArchive Documentation',
...
man_pages = [
    (master_doc, 'qcarchive', 'QCArchive Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'QCArchive', 'QCArchive Documentation',
     author, 'QCArchive', 'One line description of project.',
     'Miscellaneous'),
]
...
.. _join_slack_lower: https://join.slack.com/t/qcarchive/shared_invite/enQtNDIzNTQ2OTExODk0LTE3MWI0YzBjNzVhNzczNDM0ZTA5MmQ1ODcxYTc0YTA1ZDQ2MTk1NDhlMjhjMmQ0YWYwOGMzYzJkZTM2NDlmOGM
.. |join_slack_upper| replace:: Join our Slack group
.. _join_slack_upper: https://join.slack.com/t/qcarchive/shared_invite/enQtNDIzNTQ2OTExODk0LTE3MWI0YzBjNzVhNzczNDM0ZTA5MmQ1ODcxYTc0YTA1ZDQ2MTk1NDhlMjhjMmQ0YWYwOGMzYzJkZTM2NDlmOGM
"""
